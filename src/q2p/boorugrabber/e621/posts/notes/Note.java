...
public final class Note implements Segment, Writable {
	final int id;
	...
	public Note(final int id, final long creationDate, final long updateDate, final int x, final int y, final int width, final int height, final String body, final short version, final boolean active) {
		this.id = id;
	...
	public final boolean copyOf(final Segment stored) {
		return stored instanceof Note && ((Note)stored).id == id;
	}
}